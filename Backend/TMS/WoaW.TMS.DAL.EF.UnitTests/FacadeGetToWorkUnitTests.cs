...
{
    [TestClass]
    public class FacadeGetToWorkUnitTests
    {
        ...
        #endregion
        public FacadeGetToWorkUnitTests()
        {
            Database.SetInitializer<EmsDbContext>(new MyDropCreateDatabaseAlways());

            _initActions["GetToWorkTask_SuccessTest"] = GetToWorkTask_SuccessTest_Init;
            _initActions["CanGetToWorkTask_SuccessTest"] = CanGetToWorkTask_SuccessTest_Init;
            _initActions["CanGetToWorkTask_WrongState_FailTest"] = CanGetToWorkTask_WrongState_FailTest_Init;
            _initActions["CanGetToWorkTask_UserBusy_FailTest"] = CanGetToWorkTask_UserBusy_FailTest_Init;
        }

        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void GetToWorkTask_SuccessTest()
        {
            //arrange 
            ...
            //act
            var task = taskManagerFacade.GetToWork(taskId);
            ...
            Assert.AreEqual(EWorkEffortStatus.InWork, assignment.Status);
        }
        private void GetToWorkTask_SuccessTest_Init()
        {
            ...
            effort.Status = EWorkEffortStatus.Accepted;
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanGetToWorkTask_SuccessTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
            ...
            //act
            var can = validator.CanGetToWork(taskId);
            Assert.AreEqual(true, can);
        }
        private void CanGetToWorkTask_SuccessTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanGetToWorkTask_WrongState_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
            ...
            //act
            var can = validator.CanGetToWork(taskId);
            Assert.AreEqual(false, can);
        }
        private void CanGetToWorkTask_WrongState_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanGetToWorkTask_UserBusy_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
        ...
        private void CanGetToWorkTask_UserBusy_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
