...
{
    [TestClass]
    public class FacadeCloseUnitTests
    {
        ...
        #endregion
        public FacadeCloseUnitTests()
        {
            Database.SetInitializer<EmsDbContext>(new MyDropCreateDatabaseAlways());

            _initActions["CloseTask_SuccessTest"] = CloseTask_SuccessTest_Init;
            _initActions["CanCloseTask_SuccessTest"] = CanCloseTask_SuccessTest_Init;
            _initActions["CanCloseTask_WrongState_FailTest"] = CanCloseTask_WrongState_FailTest_Init;
            _initActions["CanCloseTask_UserFree_FailTest"] = CanCloseTask_UserFree_FailTest_Init;
        }

        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CloseTask_SuccessTest()
        {
            //arrange 
            ...
            //act
            var task = taskManagerFacade.Close(taskId);
            ...
            Assert.AreEqual(EWorkEffortStatus.Closed, assignment.Status);
        }
        private void CloseTask_SuccessTest_Init()
        {
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanCloseTask_SuccessTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
            ...
            //act
            var can = validator.CanClose(taskId);

            //assert
            Assert.AreEqual(true, can);
        }
        private void CanCloseTask_SuccessTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanCloseTask_WrongState_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
        ...
        private void CanCloseTask_WrongState_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
            ...
            //устанавливаем состояние
            effort.Status = EWorkEffortStatus.Closed;
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanCloseTask_UserFree_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
        ...
        private void CanCloseTask_UserFree_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
