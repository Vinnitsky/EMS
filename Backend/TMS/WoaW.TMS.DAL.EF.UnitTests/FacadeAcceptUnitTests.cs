...
{
    [TestClass]
    public class FacadeAcceptUnitTests
    {
        ...
        public FacadeAcceptUnitTests()
        {
            Database.SetInitializer<EmsDbContext>(new MyDropCreateDatabaseAlways());

            _initActions["AcceptTask_SuccessTest"] = AcceptTask_SuccessTest_Init;
            _initActions["CanAcceptTask_SuccessTest"] = CanAcceptTask_SuccessTest_Init;
            _initActions["CanAcceptTask_WrongState_FailTest"] = CanAcceptTask_WrongState_FailTest_Init;
            _initActions["CanAcceptTask_UserBusy_FailTest"] = CanAcceptTask_UserBusy_FailTest_Init;
        }
        ...
        public void AcceptTask_SuccessTest()
        {
            ...
            //act
            var task = taskManagerFacade.Accept(taskId);
        ...
        private void AcceptTask_SuccessTest_Init()
        {
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanAcceptTask_SuccessTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
            ...
            //act
            var can = validator.CanAccept(taskId);
            
            //assert
            Assert.AreEqual(true, can);
        }
        private void CanAcceptTask_SuccessTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanAcceptTask_WrongState_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
        ...
        private void CanAcceptTask_WrongState_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
        ...
        [TestMethod]
        [TestCategory("TMS.EF.Facade")]
        public void CanAcceptTask_UserBusy_FailTest()
        {
            //arrange 
            var taskId = TestContext.Properties["TaskId"] as string;
            var model = TestContext.Properties["ConfigModel"] as ConfigModel;
        ...
        private void CanAcceptTask_UserBusy_FailTest_Init()
        {
            var managerRoleName = "role.manager";
            var manager = TestHelper.RegisterUser(Context, TestContext, "user.manager", managerRoleName);
